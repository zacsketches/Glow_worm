#ifndef POS_JUNCTION_H
#define POS_JUNCTION_H OCT_2014
...
//gw messages
#include <messages/cmd_pos.h>
#include <messages/pos.h>
...
extern Cmd_pos_msg cmd_pos_msg;
extern Pos_msg pos_msg;
...
private:
	...
	gw::Subscriber<Cmd_pos_msg> ref_sub;
    Cmd_pos_msg local_ref_msg;

	gw::Subscriber<Pos_msg> feedback_sub;
    Pos_msg local_feedback_msg;
...
public:
	Summing_junction()
		:Node("junction"),
		ref_sub(&cmd_pos_msg, &ch, local_ref_msg),
		feedback_sub(&pos_msg, &ch, local_feedback_msg),
